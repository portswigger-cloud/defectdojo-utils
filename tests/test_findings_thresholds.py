...
@pytest.fixture
def setup_findings_thresholds_not_set():
    yield {
        "total": "false",
        "critical": "false",
        "high": "false",
...
def test_evaluate_thresholds_not_set(
    mocker, setup_active_findings, setup_findings_thresholds_not_set
):
    mocker.patch(
        "defectdojo.src.findings_thresholds.github_actions.total_findings_threshold_markdown_step_summary",
        return_value=None,
    ...
    result = findings_thresholds.evaluate_thresholds(
        setup_active_findings, setup_findings_thresholds_not_set
    )
...
def test_main_failed_thresholds_false(
    ...
    result = findings_thresholds.main()
...
def test_main_failed_thresholds_true(
    ...
    mocker.patch(
        "defectdojo.src.findings_thresholds.defectdojo_api.retrieve_defectdojo_token",
        return_value="d11dc2d650168f488e6143b6fa428483fbc7de29",
    )
    mocker.patch(
        "defectdojo.src.findings_thresholds.defectdojo_api.get_findings_count_defectdojo",
        return_value=0,
    )
    mocker.patch(
        "defectdojo.src.findings_thresholds.defectdojo_api.get_findings_defectdojo",
        return_value=findings_response_with_data,
    )
    mocker.patch(
        "defectdojo.src.findings_thresholds.findings_thresholds.evaluate_thresholds",
        return_value=True,
    )
    with pytest.raises(SystemExit) as pytest_wrapped_e:
        findings_thresholds.main()
